...
Each of these factors is statistically significant (years_since_phd, p=<.001, years_employed, p=<.001, sexMale P=0.046, disciplineTheoretical p=<.001). Overall model significantly predicts outcomes (p<.001).
