...
bar_graph_stack <- ggplot() +
  geom_bar(aes(y = Proportion, x = Year, fill = Field), data = Phds_2_expand, stat = "identity") + coord_flip() + scale_fill_brewer(palette = 16) + labs(title = "Shifts in female PhD recipients by field") +
